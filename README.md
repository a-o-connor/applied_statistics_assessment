...
The solutions to the problem set are contained in a single [Jupyter Notebook](https://github.com/a-o-connor/applied_statistics_assessment/blob/main/problems.ipynb). Some roughwork and notes made throughout the semester while studying applied statistics are contained in he `roughwork`folder.
